  ...
  return (
    <div>
      ...
      <section className='bg-white py-10 md:py-20'>
        <div className='mx-auto max-w-7xl px-6 pt-3 lg:px-8'>
          ...
          <div className='mx-auto mt-10 max-w-2xl lg:max-w-none lg:pt-24'>
      ...
      <section className='bg-white'>
        <div className='mx-auto max-w-7xl sm:px-6 lg:px-8'>
          <div className='relative isolate overflow-hidden bg-white px-6 py-10 text-center sm:rounded-3xl sm:border sm:border-gray-100 sm:px-16 sm:shadow-sm md:py-24'>
            <h2 className='mx-auto max-w-2xl text-2xl font-bold tracking-tight text-gray-900 sm:text-4xl'>
